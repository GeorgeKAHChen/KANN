...
public:
  ...
  virtual void read_from_data(const int width, const int height, unsigned char *yuvbuff, const int Dwidth, const int Dheight) {};
...
public:
  ...
  void read_from_data(const int width, const int height, unsigned char *yuvbuff, const int Dwidth, const int Dheight);
